...
import com.glodon.lingling.base.CauseCloseable;
import com.glodon.lingling.base.exception.CorruptDatabaseException;
...
public class IOUtils {
    ...
    private static MethodHandle findLocalCompareMethod(String name, MethodType type) {
        try {
            return MethodHandles.lookup().findStatic(IOUtils.class, name, type);
        } catch (Exception e2) {
            throw rethrow(e2);
        }
    }
    ...
    public static RuntimeException rethrow(Throwable e) {
        IOUtils.<RuntimeException>castAndThrow(e);
        return null;
    }
