...
import com.glodon.linglong.base.io.DirectAccess;
...
public final class DirectPageOps {
    public static final int NODE_OVERHEAD = 100 - 24; // 6 fewer fields
    ...
    public static long p_null() {
        return 0;
    }

    public static long p_nonTreePage() {
        return EMPTY_TREE_LEAF;
    }

    public static long p_closedTreePage() {
        return CLOSED_TREE_PAGE;
    }

    public static long p_stubTreePage() {
    ...
    public static long p_alloc(int size, boolean aligned) {
        return aligned ? JNA.valloc(size) : UNSAFE.allocateMemory(size);
    }

    public static long p_calloc(int size, boolean aligned) {
        long ptr = p_alloc(size, aligned);
        UNSAFE.setMemory(ptr, size, (byte) 0);
        return ptr;
    }

    public static long[] p_allocArray(int size) {
    ...
    public static Object p_arenaAlloc(int pageSize, long pageCount) throws IOException {
        Arena arena = new Arena(pageSize, pageCount);
        registerArena(arena);
        return arena;
    }

    public static void p_arenaDelete(Object arena) throws IOException {
    ...
    public static long p_calloc(Object arena, int size, boolean aligned) {
        if (arena instanceof Arena) {
    ...
    public static long p_clone(final long page, int length, boolean aligned) {
        long dst = p_alloc(length, aligned);
        UNSAFE.copyMemory(page, dst, length);
        return dst;
    }

    public static long p_transfer(byte[] array, boolean aligned) {
    ...
    public static long p_transferTo(byte[] array, final long page) {
        int length = array.length;
        p_copyFromArray(array, 0, page, 0, length);
        return page;
    }

    public static byte p_byteGet(final long page, int index) {
    ...
    public static int p_ushortGetLE(final long page, int index) {
    ...
    public static void p_shortPutLE(final long page, int index, int v) {
        if (CHECK_BOUNDS && (index < 0 || index + 2 > CHECKED_PAGE_SIZE)) {
            throw new ArrayIndexOutOfBoundsException(index);
        }
    ...
    public static int p_intGetLE(final long page, int index) {
    ...
    public static void p_intPutLE(final long page, int index, int v) {
        if (CHECK_BOUNDS && (index < 0 || index + 4 > CHECKED_PAGE_SIZE)) {
            throw new ArrayIndexOutOfBoundsException(index);
        }
    ...
    public static int p_uintGetVar(final long page, int index) {
    ...
    public static int p_uintPutVar(final long page, int index, int v) {
        if (v < (1 << 7)) {
            if (v < 0) {
    ...
    public static int p_uintVarSize(int v) {
        return Utils.calcUnsignedVarIntLength(v);
    }

    public static long p_uint48GetLE(final long page, int index) {
        return p_intGetLE(page, index) & 0xffff_ffffL
                | (((long) p_ushortGetLE(page, index + 4)) << 32);
    }

    public static void p_int48PutLE(final long page, int index, long v) {
        p_intPutLE(page, index, (int) v);
        p_shortPutLE(page, index + 4, (short) (v >> 32));
    }

    public static long p_longGetLE(final long page, int index) {
    ...
    public static void p_longPutLE(final long page, int index, long v) {
        if (CHECK_BOUNDS && (index < 0 || index + 8 > CHECKED_PAGE_SIZE)) {
            throw new ArrayIndexOutOfBoundsException(index);
        }
    ...
    public static long p_longGetBE(final long page, int index) {
        return Long.reverseBytes(p_longGetLE(page, index));
    }

    public static void p_longPutBE(final long page, int index, long v) {
        p_longPutLE(page, index, Long.reverseBytes(v));
    }

    public static long p_ulongGetVar(final long page, IntegerRef ref) {
        int offset = ref.get();
    ...
    public static int p_ulongPutVar(final long page, int index, long v) {
        if (v < (1L << 7)) {
            if (v < 0) {
    ...
    public static int p_ulongVarSize(long v) {
        return Utils.calcUnsignedVarLongLength(v);
    }

    public static void p_clear(final long page, int fromIndex, int toIndex) {
    ...
    public static byte[] p_copyIfNotArray(final long page, byte[] dstArray) {
    ...
    public static void p_copyFromBB(ByteBuffer src, final long dstPage, int dstStart, int len) {
        src.limit(src.position() + len);
        DirectAccess.ref(dstPage + dstStart, len).put(src);
        src.limit(src.capacity());
    }

    public static void p_copyToBB(final long srcPage, int srcStart, ByteBuffer dst, int len) {
        dst.put(DirectAccess.ref(srcPage + srcStart, len));
    }

    public static void p_copy(final long srcPage, int srcStart, long dstPage, int dstStart, int len) {
        if (CHECK_BOUNDS) {
            if (len < 0) {
                throw new IndexOutOfBoundsException("len: " + len);
            }
    ...
    public static void p_copies(final long page,
    ...
    public static int p_compareKeysPageToArray(final long apage, int aoff, int alen,
    ...
    public static int p_compareKeysPageToPage(final long apage, int aoff, int alen,
    ...
    public static byte[] p_midKeyLowPage(final long lowPage, int lowOff, int lowLen,
    ...
    public static byte[] p_midKeyHighPage(byte[] low, int lowOff, int lowLen,
    ...
    public static byte[] p_midKeyLowHighPage(final long lowPage, int lowOff, int lowLen,
                                             final long highPage, int highOff) {
        for (int i = 0; i < lowLen; i++) {
            byte lo = p_byteGet(lowPage, lowOff + i);
            byte hi = p_byteGet(highPage, highOff + i);
    ...
    public static int p_crc32(long srcPage, int srcStart, int len) {
        CRC32 crc = new CRC32();
