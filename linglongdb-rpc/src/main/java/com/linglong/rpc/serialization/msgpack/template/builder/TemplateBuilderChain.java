...
import com.linglong.rpc.serialization.msgpack.util.android.DalvikVmChecker;
...
public class TemplateBuilderChain {
    ...
    private static final String JAVASSIST_TEMPLATE_BUILDER_CLASS_NAME =
            "com.linglong.rpc.serialization.msgpack.template.builder.JavassistTemplateBuilder";
    private static final String REFLECTION_TEMPLATE_BUILDER_CLASS_NAME =
            "com.linglong.rpc.serialization.msgpack.template.builder.ReflectionTemplateBuilder";
